...
subtitle: "Right to Custody of Minor Child: Sections 3020 to 3204"
...
**Celia S. v. Hugo H**, 3 Cal.App.5th 655 (2016) — Clarifies that the section 3044 presumption against awarding joint custody to a parent who committed domestic abuse remains in effect for 5 years, even if a restraining order against the abuser has expired.

**Christina L. v. Chauncey B**, 229 Cal.App.4th 731 (2014) — The trial court is obligated to apply section 3044 in cases when there was a recent restraining order issued against a parent.

**Ellis v. Lyons**, 2 Cal.App.5th 404 (2016) — An out-of-state court's finding of domestic violence triggers the section 3044 presumption against granting custody to an abuser.

**In re the Marriage of Fajota**, 230 Cal.App.4th 1487 (2014) — The trial court abused its discretion by awarding joint legal custody without applying section 3044; the presumption applies even to temporary custody orders.

**Jaime G. v. H.L**, 25 Cal.App.5th 794 (2018) — A trial court cannot award any type of custody to a domestic abuser without first making findings, in writing or on the record, about each of the seven section 3044 rebuttal factors.
